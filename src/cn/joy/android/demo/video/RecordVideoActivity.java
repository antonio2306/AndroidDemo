...
public class RecordVideoActivity extends Activity implements SurfaceHolder.Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnOK = (Button) findViewById(R.id.btn_video_ok);
	...
	private void startRecord() {
		...
		Log.e("RECORD", "exs:" + mProfile.videoFrameWidth + "-" + mProfile.videoFrameHeight);
		...
		// 设置视频文件输出的路径
		// Log.e("DEMO",
		// "exs:"+Environment.getExternalStorageDirectory().getPath());
